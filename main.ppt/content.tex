...
\begin{frame}{Spoke Algorithm}
	\begin{itemize}
		\item Gathering all crossings and vertices to one point to obtain a \term{wheel diagram},
		which is corresponding to an arc presentation.
	\end{itemize}
	$$\includegraphics[width=.9\linewidth]{algorithm_spoke.png}$$
\end{frame}
