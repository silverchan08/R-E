...
\begin{frame}{Lower Bound from Yamada Polynomial}
	\begin{thm}
	Let $G$ be a non-trivial $\theta$-curve or handcuff graph.
	Then
	\[
...
\begin{frame}{Lower Bound from Yamada Polynomial}
	...
	\mypf
	\begin{itemize}
		\item Let \myem{$c_s$} and \myem{$c_{ss}$} be the number of \myem{simlpe caps} and \myem{semi-simple caps}, respectively.
