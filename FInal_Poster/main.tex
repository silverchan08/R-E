...
\begin{columns}[t]
  ...
  \end{tabular}
  \caption{Determinant of a $\thata$-curve : Line-shap and T-shape}
  \end{figure}
  \vspace*(-1cm)
  \begin{figure}[h]
  \centering
 ...
 % \end{equation*}
  ...
  \end{equation*}
    ...
    $\mathbf{Theorem\ 4.}$ $[$1$]$ Let $S_T$ be a simple closure of stacked tangle of a $\theta$-curve or handcuff graph, and let $c, n$ be the number of caps and crossings in $S_T$, respectively. Then,
