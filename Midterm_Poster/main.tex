...
\begin{columns}[t]
  ...
  \begin{block}{Definitions}
    ...
    \begin{figure}
      ...
      \caption{Reidemeister moves for theta-curves and handcuff graphs}
    \end{figure}
...
\begin{columns}[t]
  ...
  \begin{block}{Classifying Theta-Curves and Handcuff Graphs}
    ...
    The \textbf{H-deletion Matrix} of Cromwell matrix of $\theta$-curve and handcuff graph is $(n-1)\times(n-1)$ matrix which deleted row $i$ and column $j$, $k$.
