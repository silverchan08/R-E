...
\begin{frame}{Arc Presentation}
    \centering
    \begin{tabu} to .8\linewidth{X[c]X[c]X[c,1.5]X[c]X[c,1.5]}
        \raisebox{-0.5cm}{\includegraphics[height=1cm]{Trefoilimage.png}} &
        $\Longleftrightarrow$ &
        \raisebox{-0.875cm}{\includegraphics[height=1.75cm]{trefoil arc presentation.png}} &
        $\Longleftrightarrow$ &
        \raisebox{-0.5cm}{\includegraphics[height=1cm]{trefoil_grid.png}} \\
        Trefoil & & {\footnotesize Arc Presentation} & & Grid Diagram
    \end{tabu}
    \centering
    \begin{tabu} to .8\linewidth{X[c]X[c]X[c,1.5]X[c]X[c,1.5]}
        \raisebox{-0.5cm}{\includegraphics[height=1cm]{theta52.png}} &
        $\Longleftrightarrow$ &
        \raisebox{-0.875cm}{\includegraphics[height=1.75cm]{openbook.png}} &
        $\Longleftrightarrow$ &
        \raisebox{-0.5cm}{\includegraphics[height=1cm]{grid.png}} \\
        $\theta_{5,2}$ & & {\footnotesize Arc Presentation} & & Grid Diagram
    \end{tabu}
    \centering
    \begin{tabu} to .8\linewidth{X[c]X[c]X[c,1.5]X[c]X[c,1.5]}
        \raisebox{-1cm}{\includegraphics[height=2cm]{handcuff.png}} &
        $\Longleftrightarrow$ &
        \raisebox{-0.875cm}{\includegraphics[height=1.75cm]{handcuff_openbook.png}} &
        $\Longleftrightarrow$ &
        \raisebox{-0.5cm}{\includegraphics[height=1cm]{handcuff grid diagram.png}} \\
        $\Phi_{2,1}$ & & {\footnotesize Arc Presentation} & & Grid Diagram
    \end{tabu}
\end{frame}
...
\begin{frame}{Arc Presentation}
    ...
    \begin{itemize}
        \item Arc presentation with the minimal number of pages is called \term{minimal arc presentation}.
    \end{itemize}
\end{frame}
...
\begin{frame}{Grid Diagram}
    A \term{grid diagram} of $\theta$-curve or handcuff graph is a diagram with only vertical and horizontal strands.
	\begin{itemize}
...
\begin{frame}{Arc Presentation of the $\theta$-Curve and Handcuff Graph}
    ...
    \end{tabu}
    \begin{thm}
    Every $\theta$-curve and handcuff graph admits a grid diagram.
    \end{thm}
    \begin{corollary}
    Every $\theta$-curve and handcuff graph admits an arc presentation.
    \end{corollary}
\end{frame}