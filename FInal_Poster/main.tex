...
=======
  ...
  \begin{equation*}
    \alpha(H) \leq c(H) + 3
  \end{equation*}
>>>>>>> ab07acc01467c30b25303d549e80b0835522a47e
  ...
  $\mathbf{Theorem\ 6.}$ 		If $L$ is an alternating and non-split link, then
  ...
  $\mathbf{Theorem\ 7.}$ 		If $L$ is an alternating and non-split link, then
    Let $H$ be any handcuff graph
		and $L$ be constituent link of $H$.
		Then
		\[
			\alpha(H) \ge \alpha(L) + 1
		\]
