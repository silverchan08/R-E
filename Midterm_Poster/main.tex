...
\begin{columns}[t]
  ...
  \begin{block}{Definitions}
    ...
    \begin{figure}[h]
        ...
        \end{tabular}
        \caption{$\theta$-curve, handcuff graph}
    \end{figure}
    \begin{figure}
      \centering
...
\begin{columns}[t]
  ...
  \begin{block}{Refernces}
    \begin{enumerate}
      ...
      \item H. Moriuchi. (2009). \textit{A table of $\theta$-curves and handcuff graphs with up to seven crossings}. Advanced Studies in Pure Mathematics 55, 2009 Noncommutativity and Singularities
pp. 281-290
