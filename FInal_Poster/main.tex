...
\begin{columns}[t]
 ...
 % \end{equation*}
  ...
  \end{equation*}
    ...
    where $\mu(G)$, $\beta(G)$, and $E$ are the number of connected components, the first Betti number, and the edge set of $G$ respectively. Then, the \textbf{Yamada polynomial} of $G$, $R(G)$, is defined by
    \[ R(G)(x) = h(G)(-1, -x-2-x^{-1}). \]
  ...
  \begin{block}{References}
    \begin{enumerate}
      \item Yoonsang Lee. (2023). A Study on Arc Index of Theta-Curves. Korea Science Academy of KAIST
      \item Minjung Lee, Sungjong No, and Seungsang Oh. (2018). Arc index of spatial graphs. \textit{Journal of Graph Theory, 90}(3), 406–415.
