...
\begin{columns}[t]
 ...
 % \end{equation*}
  ...
  \end{equation*}
    ...
    $\mathbf{Theorem\ 7.}$ Let $S_T$ be a simple closure of stacked tangle of a $\theta$-curve or handcuff graph, and $c, n$ be the number of caps and crossings in $S_T$, respectively. Then,
