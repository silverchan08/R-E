...
\author{Eunchan Cho \inst{1} \and Jeongwon Shin \inst{1} \and Boyeon Seo \inst{1} \and Minho Choi \inst{1} \and Hun Kim \inst{2} \and Gyo-Taek Jin \inst{3}}

\institute[shortinst]{\inst{1} Researcher, Korea Science Academy of KAIST \samelineand \inst{2} Supervisor, Korea Science Academy of KAIST \samelineand \inst{3} Co-Supervisor, asdf \samelineand}
...
\begin{columns}[t]
  ...
  \begin{block}{Definitions}
    \begin{itemize}
      ...
      \item The arc presentation can be expressed by grid diagram and vice versa.
