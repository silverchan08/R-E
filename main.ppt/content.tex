\begin{frame}{What is a Knot Theory?}
$$\includegraphics[width=.3\linewidth]{figure/shoelace.png}$$
\end{frame}

\begin{frame}{What is a Knot Theory?}
	\begin{itemize}
		\item \term{Knot theory} is a field of mathematics that studies simple closed curves embedded in three-dimensional space.
	\end{itemize}
\end{frame}
...
\begin{frame}{Arc Presentation of the Theta-Curve and Handcuff Graph}
    ...
    $$\centerline{\includegraphics[width=0.4\linewidth]{figure/crossings.png}}$$
\end{frame}
