...
$\mathbf{Theorem}$ The given THC-Cromwell matrix is theta-curve if and only if determinant of the H-deletion matrix is $\pm 1$.The given THC-Cromwell matrix is handcuff knot if and only if determinant of the H-deletion matrix is 0 or $\pm 2$.
...
\subsection{Proof in the case of handcuff knot}
